...
/**
 * This class simply tests the quick sorter class for proper implementation of the insertion
 * sorter algorithm
 * 
...
public class QuickSorterTest {
	...
	public QuickSorter<Integer> integerSorter;
	/** InsertionSorter object for Students */
	public QuickSorter<Student> studentSorter;
	...
	public void testSortIntegers() {
		...
		//Test the other constructors just to make sure they are working correctly
		setUp();
		...
		integerSorter = new QuickSorter<Integer>(QuickSorter.LAST_ELEMENT_SELECTOR);
		integerSorter.sort(data);
		assertEquals(1, data[0].intValue());
		assertEquals(2, data[1].intValue());
		assertEquals(3, data[2].intValue());
		...
		integerSorter = new QuickSorter<Integer>(QuickSorter.MIDDLE_ELEMENT_SELECTOR);
		integerSorter.sort(data);
		assertEquals(1, data[0].intValue());
		assertEquals(2, data[1].intValue());
		assertEquals(3, data[2].intValue());
		...
		integerSorter = new QuickSorter<Integer>(comparator);
		integerSorter.sort(data);
		assertEquals(1, data[0].intValue());
		assertEquals(2, data[1].intValue());
		assertEquals(3, data[2].intValue());
