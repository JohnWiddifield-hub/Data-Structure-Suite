...
/**
 * This class tests the SkipListMap class for proper implementation of the data structure.
...
public class SkipListMapTest {
	...
	public void testGet() {
		...
		assertEquals("SkipListMap[1, 2, 3, 4, 5, 6, 7, 8]", map.toString());
	...
	public void testStudentMap() {
		...
		assertEquals(studentMap.toString(), "SkipListMap[L B 5, S H 3, J J 4, J K 1, J S 2]");
